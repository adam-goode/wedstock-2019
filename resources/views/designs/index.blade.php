                ...
                <div class="col-12 col-md-6 camping-info">
                    <div class="row align-items-center justify-content-center h-100 p-5">
                        <div class="col-12 col-md-10 text-center text-md-left">
                            ...
                            <p>You can also book a glamping pod, if you’re feeling a bit posh! 4m bell tents cost £160 to hire and sleep up to 4 people in style, with memory foam mattresses, fairy lights, rugs and cushions. There are other options available to sleep 6 or 8 people – just ask us if you’d like details of those. If you’d like to book one, email <a href="mailto:tipiandbelltenthire@gmail.com">tipiandbelltenthire@gmail.com</a>, quoting our names and the wedding date as a reference so they know you’re with us!</p>
    ...
    <div class="container-fluid" id="contact">
        <div class="row justify-content-center">
            <div class="col-12 p-0">
                <div class="present-hero rsvp-hero" style="height: 150vh; background-image: url('images/post.jpg');"></div>
                                    ...
                                    <form action="/enquiry/submit" method="post" class="form">
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <select name="attendance" required>
                                                <option value="" selected="true" disabled="disabled">Can you make it?</option>
                                                <option name="attendance" value="Yes, can't wait!">Yes, can't wait!!</option>
                                                <option name="attendance" value="Unfortunatly not, can't make it.">Unfortunatly not, can't make it.</option>
                                            </select>
                                         </div>
